...
const ws = new WebSocket("wss://multi-user-drawing-tool-2.onrender.com");  // WebSocket server
const API_BASE = "https://multi-user-drawing-tool-2.onrender.com/api/drawings"; // REST API
